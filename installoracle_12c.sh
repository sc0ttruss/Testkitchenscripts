...
name "ora_quickstart"
  ...
  override_attributes :oracle => {:rdbms => {:latest_patch => {:url => 'file://$VMORACLEBIN/12.1/p18031528_121010_Linux-x86-64.zip'}, :opatch_update_url => 'file://$VMORACLEBIN/12.1/p6880880_121010_Linux-x86-64.zip', :install_files => ['file://$VMORACLEBIN/12.1/linuxamd64_12c_database_1of2.zip','file://$VMORACLEBIN/12.1/linuxamd64_12c_database_2of2.zip'], :dbbin_version => '12c'}}
EOF1
